	...
	<div class="padding">
		<div class="bgwhite">
			<div class="padding">
				...
				<br>
				<div class="left">
				<a href="bayar_berikutnya.php?id_transaksi=<?= $_GET['id_transaksi'] ?>" class="btnblue" style="background:rgb(49, 243, 146)" title="Detail Pembayaran">
							Detail Pembayaran <i class="fa fa-history"></i>
						</a>

					<?php
						$link=($_SESSION['status']==1) ? "transaksi.php" : "transaksi.php";
					?>
